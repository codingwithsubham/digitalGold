...
const TermsConditions = () => {
  return (
    <div className="terms-conditions">
      ...
      <p>
        Digital Gold is committed to ensuring that the app is as useful and
      ...
      <p>
        The Digital Gold app stores and processes personal data that you have
        ...
        features and it could mean that the Digital Gold app won't work
        properly or at all.
      </p>{" "}
      <div>
        <p>
      ...
      <p>
        You should be aware that there are certain things that Digital Gold
        ...
        can be Wi-Fi or provided by your mobile network provider, but Digital
        Gold cannot take responsibility for the app not working at full
      ...
      <p>
        Along the same lines, Digital Gold cannot always take responsibility
        ...
        avail the Service, Digital Gold cannot accept responsibility.
      </p>{" "}
      <p>
        With respect to Digital Gold’s responsibility for your use of the
        ...
        we can make it available to you. Digital Gold accepts no liability
      ...
      <p>
        ...
        updates if you want to keep using the app. Digital Gold does not
